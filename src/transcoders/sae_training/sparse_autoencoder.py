...
class SparseAutoencoder(HookedRootModule):
    ...
    def __init__(
        ...
        if cfg.is_sparse_connection:
            ...
            self.spacon_sae_W_dec = state_dict['state_dict']['W_dec'] if not cfg.sparse_connection_use_W_enc else state_dict['state_dict']['W_enc']#.cuda().T
            del state_dict
