...
if __name__ == "__main__":
    ...
    pred_filt = PredictionFilter(model, batch_size = 256, checkpoint_dir = "../checkpoints",final_dicts_dir = "../final_dicts",device = device, batches_to_process = 10)
    ...
    acts = ActivationsColector(model, tokens, ["blocks.1.attn.hook_z","blocks.2.attn.hook_z",],"Features","../activations/",final_dicts_dir, cat_activations=True, quantize = True ,average = True, load = False, device = device, stop_at_layer=3)
